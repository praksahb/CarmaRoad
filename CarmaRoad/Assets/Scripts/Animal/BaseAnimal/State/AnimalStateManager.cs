...
public class AnimalStateManager : MonoBehaviour
{
    ...
    {
        if(AnimalController.AnimalModel.AnimalType == AnimalType.Small)
        {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.TryGetComponent<CarView>(out CarView vehicle))
        {
            ...
            Karma01Tracker.Instance.ReduceKarma();
